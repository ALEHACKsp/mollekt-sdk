...
public:
	...
	VFUNC_SIG(physics_run_think(int index), "client.dll", "55 8B EC 83 EC 10 53 56 57 8B F9 8B 87 ? ? ? ? C1 E8 16", bool(__thiscall*)(void*, int), index)
...
public:
	...
	NETVAR(hitbox_set(), int32_t, "CBaseAnimating->m_nHitboxSet")
